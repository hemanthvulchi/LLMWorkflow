...
class Input_Node(Node):
    ...
    def show_configuration(self):
        ...
        # Convert the config to JSON and create the dialog
        config_json = json.dumps(self.config)
        self.dialog = ConfigDialog(config_json, self.openAIclient)
        
        # If the dialog is accepted, update the config and UI elements
        if self.dialog.exec():
