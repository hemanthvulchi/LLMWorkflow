...
from PySide6.QtWidgets import QLabel, QTextEdit, QLineEdit, QPushButton, QComboBox, QFileDialog, QFormLayout
...
class PwrPointProcessorCopy_Node(Node):
    def __init__(self):
        super().__init__()
...
class ExtendedConfigDialog(ConfigDialog):
    ...
    def __init__(self, config_json, parent=None):
        ...
        self.sheet_combobox.addItem("Review powerpoint")
        self.sheet_combobox.addItem("Update powerpoint")
...
if __name__ == "__main__":
    ...
    node = PwrPointProcessorCopy_Node()
    node.show()
    sys.exit(app.exec())
